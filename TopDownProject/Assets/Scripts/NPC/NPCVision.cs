...
public class NPCVision : MonoBehaviour
{
    ...
    {
        return GameUtilities.GetDistanceIgnoringY(transform.position, Player.Instance.transform.position);
    }
    ...
    private bool IsPlayerInVision()
    {
        ...
        return !Physics.Linecast(actor.EyesPosition, player.Actor.EyesPosition, detectionMask);
    }
